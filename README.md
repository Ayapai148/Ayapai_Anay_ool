...
## 💻 Начинающий разработчик Python/Django/С++

### Обо мне
- Работаю над проектами на Django
- Базовые знания языка программирования С++
- Имеется опыт по разработке игр Godot Engine 4
- Работал на Android Studio и Qt creator
- Изучаю React и Docker
- Спрашивайте о Python, Django, REST API
